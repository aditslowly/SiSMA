        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link @if (request()->is('master-admin')) active @endif" href="{{ url('master-admin') }}" aria-expanded="false">
                        <span>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link @if (request()->is('master-admin/data-admin*')) active @endif" href="{{ url('master-admin/data-admin') }}" aria-expanded="false">
                        <span>
