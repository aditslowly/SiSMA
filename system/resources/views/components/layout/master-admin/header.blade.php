            ...
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                <li class="nav-item dropdown d-flex align-items-center">
                    ...
                    <a class="nav-link nav-icon-hover" href="#" id="drop2" data-bs-toggle="dropdown">
                        <img src="{{ url('public/app/foto-masterAdmin/' . Auth::user()->foto_profil) }}" width="40" height="40"
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                        <li>
                            <a href="{{ url('master-admin/profil') }}" class="dropdown-item d-flex align-items-center">
