                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="jenis_kelamin" id="jenis_kelamin" class="form-select" required>
                                <option value="" disabled
                                    {{ old('jenis_kelamin', $guru->jenis_kelamin) ? '' : 'selected' }}>Pilih Jenis
                                    Kelamin</option>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="agama" id="agama" class="form-select" required>
                                <option value="" disabled {{ old('agama', $guru->agama) ? '' : 'selected' }}>
                                    Pilih Agama</option>
                                <option value="Islam" {{ old('agama', $guru->agama) == 'Islam' ? 'selected' : '' }}>
                                    Islam</option>
                                <option value="Kristen"
                                    {{ old('agama', $guru->agama) == 'Kristen' ? 'selected' : '' }}>Kristen</option>
                                <option value="Katolik"
                                    {{ old('agama', $guru->agama) == 'Katolik' ? 'selected' : '' }}>Katolik</option>
                                ...
                                <option value="Konghuchu"
                                    {{ old('agama', $guru->agama) == 'Konghuchu' ? 'selected' : '' }}>Konghuchu
                                </option>
                            </select>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" id="status" class="form-select" required>
                                <option value="" disabled {{ old('status', $guru->status) ? '' : 'selected' }}>
                                    Pilih Status Guru</option>
                                <option value="Aktif"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="jabatan" id="jabatan" class="form-select" required>
                                <option value="" disabled
                                    {{ old('jabatan', $guru->jabatan) ? '' : 'selected' }}>Pilih Jabatan</option>
                                <option value="Kepala Sekolah"
                                    {{ old('jabatan', $guru->jabatan) == 'Kepala Sekolah' ? 'selected' : '' }}>Kepala
                                    Sekolah</option>
                                <option value="Waka Kesiswaan"
                                    {{ old('jabatan', $guru->jabatan) == 'Waka Kesiswaan' ? 'selected' : '' }}>Waka
                                    Kesiswaan</option>
                                <option value="Waka Kurikulum"
                                    {{ old('jabatan', $guru->jabatan) == 'Waka Kurikulum' ? 'selected' : '' }}>Waka
                                    Kurikulum</option>
                                <option value="Guru"
                                    {{ old('jabatan', $guru->jabatan) == 'Guru' ? 'selected' : '' }}>Guru</option>
                                <option value="Tata Usaha"
                                    {{ old('jabatan', $guru->jabatan) == 'Tata Usaha' ? 'selected' : '' }}>Tata Usaha
                                </option>
                            </select>
                        </div>
                        <div class="mb-3">
                            ...
                            <select name="pendidikan_terakhir" id="pendidikan_terakhir" class="form-select" required>
                                <option value="" disabled
                                    {{ old('pendidikan_terakhir', $guru->pendidikan_terakhir) ? '' : 'selected' }}>
                                    Pilih Pendidikan Terakhir</option>
                                <option value="Diploma"
                                    {{ old('pendidikan_terakhir', $guru->pendidikan_terakhir) == 'Diploma' ? 'selected' : '' }}>
                                    Diploma</option>
                                <option value="Sarjana"
                                    {{ old('pendidikan_terakhir', $guru->pendidikan_terakhir) == 'Sarjana' ? 'selected' : '' }}>
                                    Sarjana</option>
                                <option value="Megister"
                                    {{ old('pendidikan_terakhir', $guru->pendidikan_terakhir) == 'Megister' ? 'selected' : '' }}>
                                    Megister</option>
                                <option value="Doktor"
                                    {{ old('pendidikan_terakhir', $guru->pendidikan_terakhir) == 'Doktor' ? 'selected' : '' }}>
                                    Doktor</option>
                            </select>
                        </div>
                        <div class="mb-3">
